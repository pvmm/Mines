 ...
 *
 * This macro can use variable argument support (variadic macros) to include a message in
 * case of assertion failure, but you can set NO_VARIADIC first to disable this feature.
 */
